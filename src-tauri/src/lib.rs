...
macro_rules! app_invoke_handler {
    ($($extra:path),* $(,)?) => {
        tauri::generate_handler![
            ...
            commands::skin_forge::skin_forge_get_config,
            commands::skin_forge::skin_forge_cache_image,
            commands::skin_forge::skin_forge_load_loadout,
            commands::skin_forge::skin_forge_save_loadout,
            commands::skin_forge::skin_forge_reset_loadout,
            commands::skin_forge::skin_forge_check_plugin,
            commands::skin_forge::skin_forge_deploy_plugin,
